...
*/
    ...
    FUNCTION_PATH		: "/media/contentbox/js/functions.js",
...
jQuery.fn.wymeditor = function(options) {
  ...
  options = jQuery.extend({
    ...
    dialogHtml:      "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN'"
                      ...
                      + WYMeditor.WYM_PATH
                      + "'></script>"
                      + '<script src="/media/contentbox/js/wymeditor/plugins/hovertools/jquery.wymeditor.hovertools.js" type="text/javascript"></script><script src="/media/contentbox/js/jqueryui/ui.jquery.js" type="text/javascript"></script><script type="text/javascript" src="/media/contentbox/js/fancybox/jquery.mousewheel.js"></script><script type="text/javascript" src="/media/contentbox/js/fancybox/jquery.fancybox.js"></script><script type="text/javascript" src="/media/contentbox/js/uploadify/scripts/swfobject.js"></script><script type="text/javascript" src="/media/contentbox/js/uploadify/scripts/jquery.uploadify.js"></script><script src="/media/contentbox/js/functions.js" type="text/javascript"></script>'
                      + "</head>"
...
WYMeditor.INIT_DIALOG = function(index) {
  ...
  jQuery(wym._options.dialogLinkSelector + " "
   ...
   jQuery(wym._options.dialogImageSelector + " "
    + wym._options.submitSelector).live("click",function(){		
